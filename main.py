...
MODEL_PATH = "C:/Users/swanl/Documents/AI/text-generation-webui/user_data/models/L3-8B-Stheno-v3.2-Q4_K_M.gguf"
...
async def on_message(message):
    if bot.user in message.mentions and not message.author.bot:
        ...
        # Formatage amélioré de l'historique pour le prompt
        history = ""
